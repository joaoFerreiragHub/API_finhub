...
| P8 — Elevação UI/UX | 🔄 Em curso | P8.1-P8.4 ✅, P8.7 ✅, P8.8 ✅, P8.9 ✅, P8.10 ✅ (cards+páginas+estados), P8.6 ✅ (FinHubScore snowflake), P8.5 ✅ (Header SSR-safe + redesign) |

**Bugs conhecidos abertos:** B15 (login/registar +Page.tsx — requer restart dev server), B16 (dev mock token) | B9-B14 resolvidos

**Sequência:** ✅ P4-GATE → ✅ P8.6 → ✅ P5-FIRE → ✅ P8.5 → **P5-OB** → P5-PRICE → BETA-GATE → beta
