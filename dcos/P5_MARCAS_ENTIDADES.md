...
Atualizacao de execucao: 2026-03-10 (backend P1.1 + P1.5 + P1.6 + P2.1 + P2.2 + P2.3 + P2.5 + P2.6 + P3.1 + P3.2 + P3.3 + P3.4 + P3.5 + P3.6 + P3.7 entregue; P4.1 base backend iniciada).
...
| # | Item | Backend | Frontend | Esforco |
|---|------|---------|----------|---------|
| 4.1 | **Portal de marca** | INICIADO (2026-03-10): `GET /api/brand-portal/overview` para dono de `DirectoryEntry` com ownership + campanhas + tracking agregado (janela 1-90 dias) | Portal separado ou seccao dedicada | Alto |
