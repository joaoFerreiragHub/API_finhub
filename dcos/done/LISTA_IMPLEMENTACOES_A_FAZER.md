...
1. Esta lista e o inventario central de tudo o que nao esta fechado.
2. Itens com ficheiro ativo em `dcos/` ficam em `Pendentes em curso` com estado `em_curso` ou `planeado`.
3. Ideias ainda sem execucao ficam em `Backlog futuro` com estado `proposto`.
4. Quando o P terminar, o ficheiro correspondente deve ser movido para `dcos/done/`.

## Pendentes em curso (ficheiros ativos em `dcos/`)
