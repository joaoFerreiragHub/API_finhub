...
| O1-04 | concluido | 2026-03-08 | Backend+frontend fechados: API publica de documentos legais (`/api/platform/legal/*`), aceite legal obrigatorio no registo, update de consentimento em `PATCH /api/auth/cookie-consent`, paginas publicas (`/termos`, `/privacidade`, `/cookies`, `/aviso-legal`) com conteudo real e banner RGPD de cookies ligado ao consentimento de analytics. |
