...
const ROUTE_CONTRACTS = [
  ...
  {
    filePath: 'src/routes/directory.routes.ts',
    method: 'get',
    routePath: '/',
    requiredMiddleware: 'validatePublicDirectoryListContract',
  },
  {
    filePath: 'src/routes/directory.routes.ts',
    method: 'get',
    routePath: '/featured',
    requiredMiddleware: 'validatePublicDirectoryFeaturedContract',
  },
  {
    filePath: 'src/routes/directory.routes.ts',
    method: 'get',
    routePath: '/categories',
    requiredMiddleware: 'validatePublicDirectoryCategoriesContract',
  },
  {
    filePath: 'src/routes/directory.routes.ts',
    method: 'get',
    routePath: '/search',
    requiredMiddleware: 'validatePublicDirectorySearchContract',
  },
  {
    filePath: 'src/routes/directory.routes.ts',
    method: 'get',
    routePath: '/compare',
    requiredMiddleware: 'validatePublicDirectoryCompareContract',
  },
  {
    filePath: 'src/routes/directory.routes.ts',
    method: 'get',
    routePath: '/:vertical/:slug/related-content',
    requiredMiddleware: 'validatePublicDirectoryRelatedContentContract',
  },
  {
    filePath: 'src/routes/directory.routes.ts',
    method: 'get',
    routePath: '/:vertical/:slug',
    requiredMiddleware: 'validatePublicDirectoryDetailContract',
  },
  {
    filePath: 'src/routes/directory.routes.ts',
    method: 'get',
    routePath: '/:vertical',
    requiredMiddleware: 'validatePublicDirectoryByVerticalContract',
  },
  {
